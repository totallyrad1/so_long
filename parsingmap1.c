...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/08 22:54:05 by asnaji            #+#    #+#             */
/*   Updated: 2023/12/08 22:59:28 by asnaji           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	flood_fill(t_game_info **game, int i, int j)
{
	...
	m = getheight((*game)->map2);
	n = getwidth((*game)->map2[0]);
	if (i < 0 || i >= m || j < 0 || j >= n
		|| (*game)->map2[i][j] == '1' || (*game)->map2[i][j] == 'F')
	{
		return ;
	}
	else
